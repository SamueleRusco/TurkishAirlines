...
public class PostoDTO {
	...
	public String toString() {
		return "PostoDTO [id=" + id + ", numeroPosto=" + numeroPosto + ", volo=" + volo + ", larghezzaPosto="
				+ larghezzaPosto + ", tipoVideo=" + tipoVideo + ", alimentazione=" + alimentazione + ", wifi=" + wifi
				+ ", tipoSeduta=" + tipoSeduta + ", ciboSpeciale=" + ciboSpeciale + ", prezzo=" + prezzo
				+ ", classePosto=" + classePosto + ", logicDelete=" + logicDelete + ", ultimaModifica=" + ultimaModifica
				+ ", voloId=" + voloId + ", utenteId=" + utenteId + "]";
	}
